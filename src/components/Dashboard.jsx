            ...
            <div style={dashboardStyles.dashboardIntro}>
                <div style={dashboardStyles.textBoxWrapper}>
                    ...
                    <div style={dashboardStyles.textBoxStyle}>
                        <h3 style={dashboardStyles.textLine1Style}>MELBOURNE</h3>
                        <h3 style={dashboardStyles.textLine2Style}>OPEN DATA</h3>
                        <h3 style={dashboardStyles.textLine3Style}> PROJECT</h3>
